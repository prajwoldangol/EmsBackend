...
public class EmsEmployeeMgmtController {
    ...
    @PostMapping("/add")
    public ResponseEntity<EmsEmployee> addNewEmployee(@RequestBody EmsEmployeeDto emsEmployee) {
        return ResponseEntity.ok(emsEmployeeService.createEmployee(emsEmployee));
    }
}
